    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72 }}>
        ...
        <button onClick={() => go('home')} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: 36, height: 36, background: YELLOW, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 700, fontSize: '1.1rem', color: '#111' }}>ZB</span>
          </div>
          <div style={{ textAlign: 'left' }}>
            <div style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 700, fontSize: '1rem', color: '#fff', letterSpacing: '0.05em', lineHeight: 1.1 }}>ZUNGU BROTHERS</div>
            <div style={{ fontSize: '0.6rem', color: '#888', letterSpacing: '0.15em', textTransform: 'uppercase' }}>PTY LTD</div>
          </div>
        </button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }} className="hidden-mobile">
          ...
          <button onClick={() => go('contact')} className="btn-primary" style={{ fontSize: '0.8rem', padding: '0.6rem 1.25rem' }}>
            Request a Quote
          </button>
        </div>
      ...
      {menuOpen && (
        <div style={{ background: '#111', borderTop: '1px solid #222', padding: '1rem 2rem 1.5rem' }}>
          ...
          <button onClick={() => go('contact')} className="btn-primary" style={{ marginTop: '1rem', width: '100%', textAlign: 'center', fontSize: '0.85rem' }}>
            Request a Quote
          </button>
        </div>
      )}
    ...
    <footer style={{ background: '#0a0a0a', borderTop: '1px solid #1e1e1e', paddingTop: '4rem', paddingBottom: '2rem' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <div style={{ width: 36, height: 36, background: YELLOW, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 700, fontSize: '1rem', color: '#111' }}>ZB</span>
              </div>
              <div>
                <div style={{ fontFamily: 'Oswald, sans-serif', fontWeight: 700, color: '#fff', fontSize: '0.95rem', letterSpacing: '0.05em' }}>ZUNGU BROTHERS</div>
                <div style={{ fontSize: '0.6rem', color: '#666', letterSpacing: '0.15em', textTransform: 'uppercase' }}>PTY LTD</div>
              </div>
            </div>
          ...
          <div>
            ...
            {[
              { icon: '📞', text: '+27 11 000 1234' },
              { icon: '✉️', text: 'info@zungubrothers.co.za' },
              { icon: '📍', text: 'midrand, Gauteng, South Africa' },
            ].map(({ icon, text }) => (
        ...
        <div style={{ borderTop: '1px solid #1e1e1e', paddingTop: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <p style={{ color: '#444', fontSize: '0.8rem' }}>© 2021 Zungu Brothers Pty Ltd. All rights reserved.</p>
    ...
    <div style={{ background: '#0f0f0f', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', height: '100vh', minHeight: 600, display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, background: '#111' }}>
          <img src="https://images.unsplash.com/photo-1523848309072-c199db53f137?w=1800&h=900&fit=crop&auto=format" alt="Mining excavators at work" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.4 }} />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(90deg, rgba(10,10,10,0.95) 40%, rgba(10,10,10,0.3) 100%)' }} />
        </div>
        <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', padding: '0 2rem', width: '100%' }}>
          <div style={{ maxWidth: 680 }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <button onClick={() => go('contact')} className="btn-primary" style={{ fontSize: '0.9rem' }}>Request a Quote</button>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(10,10,10,0.9)', borderTop: `1px solid ${YELLOW}`, padding: '1.25rem 2rem' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap', gap: '1rem' }}>
            {[{ n: '10+', l: 'Years Experience' }, { n: '200+', l: 'Projects Completed' }, { n: '50+', l: 'Equipment Units' }, { n: '100%', l: 'Safety Compliant' }].map(({ n, l }) => (
      ...
      <section style={{ padding: '6rem 2rem', background: '#111' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
          ...
          <div>
            <div className="section-label" style={{ marginBottom: '0.75rem' }}>Why Zungu Brothers</div>
      ...
      <section style={{ padding: '6rem 2rem', background: '#0f0f0f' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            {[
              { quote: "Zungu Brothers delivered our excavators on-site within 48 hours. Their support team is second to none — we've renewed our contract three years running.", author: 'Sipho Dlamini', role: 'Operations Manager, Kumba Iron Ore' },
      ...
      <section style={{ padding: '5rem 2rem', background: YELLOW }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <button onClick={() => go('contact')} style={{ background: '#111', color: '#fff', fontFamily: 'Oswald, sans-serif', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0.85rem 2rem', border: 'none', cursor: 'pointer', fontSize: '0.9rem', transition: 'background 0.2s' }}
              onMouseEnter={e => (e.currentTarget.style.background = '#222')}
              onMouseLeave={e => (e.currentTarget.style.background = '#111')}>
              Request a Quote
            </button>
            <button onClick={() => go('contact')} style={{ background: 'transparent', color: '#111', fontFamily: 'Oswald, sans-serif', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0.85rem 2rem', border: '2px solid #111', cursor: 'pointer', fontSize: '0.9rem', transition: 'background 0.2s, color 0.2s' }}
    ...
    <div style={{ background: '#0f0f0f', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', paddingTop: 180, paddingBottom: '5rem', paddingLeft: '2rem', paddingRight: '2rem', background: '#111', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Oswald, sans-serif', fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', fontWeight: 700, color: '#fff', lineHeight: 1.05 }}>About Zungu Brothers</h1>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: '#888', lineHeight: 1.9, marginBottom: '1.25rem', fontSize: '0.95rem' }}>
              Zungu Brothers Pty Ltd was founded with a clear purpose: to give mining and construction operations across South Africa access to dependable, high-performance equipment backed by real expertise.
            </p>
            <p style={{ color: '#888', lineHeight: 1.9, marginBottom: '1.25rem', fontSize: '0.95rem' }}>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: '#888', lineHeight: 1.9, marginBottom: '2rem', fontSize: '0.95rem' }}>
              In the mining industry, safety is not a differentiator — it is the baseline. All Zungu Brothers equipment and operations adhere to the Mine Health and Safety Act (MHSA) and the Occupational Health and Safety Act (OHSA).
            </p>
      ...
      <section style={{ padding: '5rem 2rem', background: '#0f0f0f', textAlign: 'center' }}>
        ...
        <button onClick={() => { setPage('contact'); window.scrollTo(0, 0) }} className="btn-primary">Get in Touch</button>
      </section>
    </div>
  )
}
            ...
            {categories[activeTab].items.map(({ name, specs, img }) => (
              <div key={name} className="card-hover" style={{ background: '#111', border: '1px solid #222', overflow: 'hidden' }}>
                ...
                <div style={{ padding: '1.75rem' }}>
                  ...
                  <button onClick={() => { setPage('contact'); window.scrollTo(0, 0) }} className="btn-primary" style={{ fontSize: '0.78rem', padding: '0.6rem 1.25rem' }}>
                    Request Quote
                  </button>
                </div>
              </div>
    ...
    <div style={{ background: '#0f0f0f', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '5rem 2rem', background: YELLOW, textAlign: 'center' }}>
        ...
        <button onClick={() => { setPage('contact'); window.scrollTo(0, 0) }}
          style={{ background: '#111', color: '#fff', fontFamily: 'Oswald, sans-serif', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0.85rem 2.5rem', border: 'none', cursor: 'pointer', fontSize: '0.9rem' }}>
          Request a Quote
        </button>
      </section>
    </div>
  ...
  const projects = [
    {
      ...
      solution: 'Zungu Brothers mobilized a full fleet with operators within 72 hours. Our on-site support team managed shift handovers and equipment inspections.',
    ...
    },
    {
      ...
      solution: 'Zungu Brothers designed, supplied, and commissioned a complete primary and secondary crushing circuit with operator training.',
  ...
  return (
    <div style={{ background: '#0f0f0f', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '5rem 2rem', background: '#111', textAlign: 'center' }}>
        ...
        <button onClick={() => { setPage('contact'); window.scrollTo(0, 0) }} className="btn-primary">Start a Conversation</button>
      </section>
    </div>
  )
}
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '5rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', marginBottom: '3rem' }}>
              {[
                { icon: '📞', label: 'Phone', value: '+27 11 000 1234', sub: 'Mon–Fri, 07:00–17:00 SAST' },
                { icon: '✉️', label: 'Email', value: 'kemistsoolebogeng@gmail.com', sub: 'We respond within 24 hours' },
                { icon: '📍', label: 'Head Office', value: 'Midrand, Gauteng', sub: 'South Africa' },
                { icon: '💬', label: 'WhatsApp', value: '+27 82 000 0000', sub: 'Available 07:00–19:00' },
            ...
            {/* WhatsApp Button */}
            <a href="https://wa.me/27820000000" target="_blank" rel="noopener noreferrer"
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                    <div>
                      ...
                      <input required placeholder="+27 82 000 0000" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} />
                    </div>
                    <div>
